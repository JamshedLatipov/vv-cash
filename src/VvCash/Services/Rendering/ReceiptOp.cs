...
/// он превращает несходящийся размер receipt_logo или диапазон вне 0..65535 в
/// понятное исключение, которое ParseLogo ловит и превращает в «логотипа
/// нет» вместо падения печати.</summary>
