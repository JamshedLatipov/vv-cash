...
public interface IQueueSettings
{
    ...
    /// <summary>Номер кассы 0..TillCount−1 — её срез в пуле (класс вычетов при
    /// перемешивании, сплошной блок без него; см. QueueNumberSlice). Две кассы с
    ...
    /// <summary>Сколько касс делят диапазон номеров. Раньше была константа
